<nav x-data="{ open: false }" class="sticky top-0 bg-anchor-ylw border-b border-anchor-ylw">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                <div class="ml-3 relative">
                    ...
                    <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                        <a href="{{ route('login') }}" class="text-sm text-syphon-dk-bl  underline">Log in</a>
                        <a href="{{ route('register') }}" class="ml-4 text-sm text-syphon-dk-bl  underline">Register</a>
                    </div>
                    @endhasrole
                </div>
            </div>
