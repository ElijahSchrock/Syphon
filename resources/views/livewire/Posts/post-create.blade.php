            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-syphon-dk-bl overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 bg-syphon-dk-bl border-b border-syphon-dk-bl text-white">
                        <form method="POST" action="{{ route('posts.store') }}" class="space-y-8 divide-y divide-gray-800" wire:submit.prevent="save">
                            ...
                            <div class="space-y-8 divide-y divide-gray-800">
                                    ...
                                    <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                                        <div class="sm:col-span-4">
                                            ...
                                            <div class="mt-1 flex rounded-md shadow-sm">
                                                <input type="text" name="title" id="title" class="flex-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full min-w-0 rounded-md rounded-r-md sm:text-sm border-gray-300 bg-gray-800" wire:model.defer="post.title"/>
                                                @error('name')
                                ...
                                <div class="pt-5">
                                    <div class="flex justify-end">
                                        <button type="button" class="bg-gray-800 py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-white hover:text-black
                                        hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Cancel</button>
                                        <button wire:click="save" type="submit" class="ml-3 inline-flex justify-center py-2 px-4 border border-white shadow-sm text-sm font-medium rounded-md text-black bg-anchor-ylw hover:bg-syphon-lt-bl hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Post</button>
                                    </div>
                                </div>
                        </form>
                    </div>
