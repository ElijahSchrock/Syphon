...
<nav class="border-t border-gray-200 px-4 flex items-center justify-between sm:px-0">
    ...
    <div class="-mt-px w-0 flex-1 flex">
      <a wire:click="nextPage" class="border-t-2 border-transparent pt-4 pl-1 inline-flex items-center text-sm font-medium text-white hover:text-white hover:border-gray-300">
        Next
